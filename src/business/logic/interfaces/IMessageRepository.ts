...
export interface IMessageRepository {
    ...
    findByConversationId(conversationId: string, limit?: number, before?: Date, currentIdentityId?: string): Promise<Message[]>;
    getLatestSequenceId(conversationId: string): Promise<number>;
    softDelete(id: string): Promise<void>;
    hideForUser(messageId: string, identityId: string): Promise<void>;
